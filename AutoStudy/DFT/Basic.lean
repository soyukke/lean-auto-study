...
-- ============================================================
-- 1D Toy Model: 実数値 1 粒子波動関数に基づく簡略モデル
-- 3 次元多電子版は ManyBody3D.lean を参照。
-- ============================================================

namespace ToyModel1D
...
-- 後方互換: DFT 名前空間に ToyModel1D の定義を再エクスポート
export ToyModel1D (innerProduct IsNormalized electronDensity expectationValue IsEigenstate)
